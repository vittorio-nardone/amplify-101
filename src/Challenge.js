    ...
    (
            <div className="Challenge">
              ...
              <form onSubmit={this.handleSubmit} className="ChallengeForm">
                ...
                <div className="App-footer" style={{fontSize: 28}}>
                  <b>time:</b> <TimeCounter/> - <b>personal best:</b>
                  {this.props.challenge.personal_best === 0 ?
                      (' none') :
                      (' ' + this.props.challenge.personal_best)
                  }
                </div>
              </form>
            </div>
