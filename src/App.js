    ...
    return this.state.authState === 'signedin' ? (
      ...
      <div className="App">
        <header className="App-header">
          ...
          <div className="App-header-contents App-header-user">
            <b>User:</b>
          ...
          <div className="App-body"><Scoreboard/>
            <p>
              <button
                ...
                disabled={this.state.loadingChallenge}
                onClick={() => this.newChallenge() }>
                {this.state.loadingChallenge ?
                '...generating...' :
                'NEW CHALLENGE!'}
              </button>
            </p>
      ...
      <div className="App">
        <header className="App-header">
          <p className="App-header-contents">
            <b>Amplify 101 - Learn math!</b>
          </p>
        </header>
